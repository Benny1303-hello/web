...
// partner of (text-only on the old site — no logo assets to source).
export const systemIntegrationPartnerBrands = ['IBM', 'HPE', 'Dell', 'Cisco', 'Juniper', 'Sophos', 'Intel', 'Microsoft'];
