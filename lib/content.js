...
// partner of (named as text only on the old site — logos sourced separately
// from each brand's official Wikimedia Commons file for display here).
export const systemIntegrationPartnerBrands = [
  { name: 'IBM', logo: '/partner-logos/ibm.svg' },
  { name: 'HPE', logo: '/partner-logos/hpe.svg' },
  { name: 'Dell', logo: '/partner-logos/dell.svg' },
  { name: 'Cisco', logo: '/partner-logos/cisco.svg' },
  { name: 'Juniper', logo: '/partner-logos/juniper.svg' },
  { name: 'Sophos', logo: '/partner-logos/sophos.svg' },
  { name: 'Intel', logo: '/partner-logos/intel.svg' },
  { name: 'Microsoft', logo: '/partner-logos/microsoft.svg' },
];
