export const site = {
  ...
  // no code change needed. Shared by sitemap.xml, robots.txt, and product
  // JSON-LD so there's one fact instead of three independent fallbacks.
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://web-vxfh.vercel.app',
  name: 'TTC-Infotech',
  ...
  address: '58 Mac Dinh Chi Street, Tan Dinh Ward, Ho Chi Minh City, Viet Nam',
  mapHref: 'https://maps.google.com/?q=58%20Mac%20Dinh%20Chi%20Street%2C%20Tan%20Dinh%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%20Viet%20Nam',
  facebook: 'https://www.facebook.com/',
  zalo: 'https://zalo.me/0908161313',
  whatsapp: 'https://wa.me/84908161313',
};
        ...
        children: [
          {
            ...
            key: 'productsApc',
            children: [
              { href: '/products/ups', key: 'productsUps' },
              { href: '/products/phu-kien-ups', key: 'productsAccessories' },
              { href: '/products/tu-rack', key: 'productsRack' },
            ],
          },
          {
            href: '/products',
            key: 'productsEaton',
            children: [
              { href: '/products/eaton-ups', key: 'productsUps' },
              { href: '/products/eaton-phu-kien-ups', key: 'productsAccessories' },
            ],
          },
        ],
      },
...
export const companyCapabilities = [
  { key: 'networkConsulting', icon: 'Network' },
  { key: 'networkCabling', icon: 'Cable' },
  { key: 'systemIntegration', icon: 'Layers' },
  { key: 'lanWanEmail', icon: 'Wifi' },
  { key: 'maintenance', icon: 'Wrench' },
  { key: 'hardwareDistribution', icon: 'PackageCheck' },
  { key: 'rental', icon: 'MonitorSmartphone' },
  { key: 'softwareLicensing', icon: 'KeyRound' },
];
...
export const distributionStaff = [
  {
    groupKey: 'sales',
    members: [
      { key: 'phuong', name: 'Vũ Chính Phương', phone: '0903 362 224', email: 'phuong.vc@ttc-infotech.com.vn', phase: '1' },
      { key: 'xuan', name: 'Nguyễn Xuân', phone: '0905 106 846', email: 'xuan.nguyen@ttc-infotech.com.vn', phase: '1' },
      { key: 'danh', name: 'Võ Thành Danh', phone: '0934 035 316', email: 'danh.vt@ttc-infotech.com.vn', phase: '1' },
      { key: 'tuananh', name: 'Đặng Tuấn Anh', phone: '0903 127 025', email: 'anh.dt@ttc-infotech.com.vn', phase: '3' },
    ],
  },
];
...
// The System Integration Center's own "featured clients" wall on the old
// site — a distinct logo set from serviceClients above, even where a company
// name overlaps (e.g. Parker, FedEx), so kept as its own list rather than
// merged.
export const systemIntegrationClients = [
  { name: 'Terumo', image: '/system-integration-clients/terumo.jpg' },
  { name: 'Vinasoy', image: '/system-integration-clients/vinasoy.png' },
  { name: 'Yuen Foong Yu', image: '/system-integration-clients/yuen-foong-yu.png' },
  { name: 'Long Thanh Golf', image: '/system-integration-clients/long-thanh-golf.png' },
  { name: 'Parker', image: '/system-integration-clients/parker.png' },
  { name: 'Far Eastern Apparel Vietnam', image: '/system-integration-clients/far-eastern-apparel.jpg' },
  { name: 'Gemadept', image: '/system-integration-clients/gemadept.jpg' },
  { name: 'Gem Center', image: '/system-integration-clients/gem-center.jpg' },
  { name: 'The Palace', image: '/system-integration-clients/the-palace.jpg' },
  { name: 'Estée Lauder', image: '/system-integration-clients/estee-lauder.png' },
  { name: 'Chailease', image: '/system-integration-clients/chailease.jpg' },
  { name: 'Generali Vietnam', image: '/system-integration-clients/generali.jpg' },
  { name: 'Mekong Energy', image: '/system-integration-clients/mekong-energy.jpg' },
  { name: 'Fubon Bank', image: '/system-integration-clients/fubon-bank.png' },
  { name: 'FedEx', image: '/system-integration-clients/fedex.png' },
  { name: 'DHL', image: '/system-integration-clients/dhl.jpg' },
  { name: 'Saint-Gobain', image: '/system-integration-clients/saint-gobain.png' },
  { name: 'Panalpina', image: '/system-integration-clients/panalpina.jpg' },
  { name: 'Mindshare', image: '/system-integration-clients/mindshare.jpg' },
];

// Technology vendors the System Integration Center is a certified/training
// partner of (named as text only on the old site). Reuses the same `partners`
// logos above rather than a second copy, so the two pages can't drift into
// showing different logos for the same brand.
const SYSTEM_INTEGRATION_PARTNER_NAMES = ['IBM', 'HPE', 'Dell', 'Cisco', 'Juniper', 'Sophos', 'Intel', 'Microsoft'];
export const systemIntegrationPartnerBrands = SYSTEM_INTEGRATION_PARTNER_NAMES.map((name) =>
